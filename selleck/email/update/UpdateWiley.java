...
//	public static final String DOWNLOAD_DIR = "";
	...
	public static void main(String[] args) {
		...
		final UpdateWiley updateWiley = new UpdateWiley();
			...
			public void run() {
				while (true) {
					...
					if (select.equals("自动更新Wiley文章")) {
						...
						updateWiley.wileyService = new WileyServiceImpl(dbName);
	 ...
	 * @param dateRange  时间段，可以是YYYY-YYYY ，也可以是1 Month , 3 Months ....
	 */
	public void getArticleUrl(String journal , String dateRange) {
		loggerTA.append("开始查询期刊"+journal+" "+dateRange+"\n");
		String resultCount = "";
...
//		}
		...
		reqParam.put("searchRowCriteria[0].queryString","\""+journal+"\"");
	...
	public void queryArticles(String pubName){
		...
		for(Wiley wiley : wileys){
			try{
				...
				List<String> freeSpans= ParserUtils.findInContent("(<span class=\"freeAccess\" title=\"You have free access to this content\">)|(<span class=\"openAccess\" title=\"You have full text access to this OnlineOpen article\">)", articleHtml);
	...
	private static Map<String, String> getBaseHttpRequestParameter() {
		...
		reqParam.put("searchRowCriteria[0].fieldName","publication-title"); // 期刊名
