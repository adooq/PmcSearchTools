...
public class UpdateSpringerFrame extends FrameClass{
	...
	private UpdateSpringerFrame(){
		initControls();
		initLayout();
	}
	
	public static final UpdateSpringerFrame getFrame(){
		UpdateSpringerFrame frame = new UpdateSpringerFrame();
	...
	private void initControls(){
		...
		moveCB = new JComboBox<String>(new String[]{"自动更新Springer文章"});
		...
		excelText =  new JTextField("springer publications.xlsx",15); // excel 文件名 label
