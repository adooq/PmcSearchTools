...
public class UpdateYellowPageFrame extends FrameClass{
	...
	private UpdateYellowPageFrame(){
		initControls();
		initLayout();
	}
	
	public static final UpdateYellowPageFrame getFrame(){
		UpdateYellowPageFrame frame = new UpdateYellowPageFrame();
	...
	private void initControls(){
		...
		moveCB = new JComboBox<String>(new String[]{"自动更新YellowPage"});
		...
		// publicationText = new JTextField("2009/01/01", 10); // 
		// cookieText =  new JTextField("2014/06/30",10); // 
		excelText =  new JTextField("yellowPage.xlsx",15); // excel 文件名 label
...
//		pLable.add(cookieText);
		...
		textLable.add(new JLabel("搜索州范围(1-50): "));
