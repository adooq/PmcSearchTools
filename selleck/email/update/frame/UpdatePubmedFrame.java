...
public class UpdatePubmedFrame extends FrameClass{
	...
	private UpdatePubmedFrame(){
		initControls();
		initLayout();
	}
	
	public static final UpdatePubmedFrame getFrame(){
		UpdatePubmedFrame frame = new UpdatePubmedFrame();
	...
	private void initControls(){
		...
		moveCB = new JComboBox<String>(new String[]{"自动更新Pubmed文章"});
		...
		publicationText = new JTextField("2015/07/01", 10); // 把publicationText当做startEntrez用
		cookieText =  new JTextField("2015/07/01",10); // 把cookieText当做endEntrez用
